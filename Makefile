...
bench-plain:
	swift run PlainBench -- --urls $(URLS) --iterations $(SMOKE_ITERATIONS) --mode both --out benchmarks/results/plain.json
...
bench-compare:
	node benchmarks/compare.mjs --plain benchmarks/results/plain.json --browser benchmarks/results/browser-$(BROWSER).json --out benchmarks/results/comparison.json --policy smoke
...
bench-plain-marketing:
	swift run PlainBench -- --urls $(MARKETING_URLS) --iterations $(MARKETING_ITERATIONS) --mode both --out benchmarks/results/plain-marketing.json
...
bench-compare-marketing:
	node benchmarks/compare.mjs --plain benchmarks/results/plain-marketing.json --browser benchmarks/results/browser-marketing.json --out benchmarks/results/comparison-marketing.json --policy marketing
...
bench-publish-marketing:
	node benchmarks/publish-approved.mjs --comparison benchmarks/results/comparison-marketing.json --plain benchmarks/results/plain-marketing.json --browser benchmarks/results/browser-marketing.json --urls $(MARKETING_URLS) --out-dir benchmarks/approved
...
bench-power-measure:
	node benchmarks/power-runner.mjs --urls $(MARKETING_URLS) --iterations $(MARKETING_ITERATIONS) --out benchmarks/results/power-marketing.json --plain-out benchmarks/results/plain-power.json --browser-out benchmarks/results/browser-power.json
...
bench-power-publish:
	node benchmarks/publish-approved.mjs --comparison benchmarks/approved/latest/comparison-marketing.json --plain benchmarks/approved/latest/plain-marketing.json --browser benchmarks/approved/latest/browser-marketing.json --urls benchmarks/approved/latest/urls-marketing.txt --power benchmarks/results/power-marketing.json --out-dir benchmarks/approved
