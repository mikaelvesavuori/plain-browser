...
You can also email [hello@browseplain.com](mailto:hello@browseplain.com) or open a [GitHub issue](https://github.com/mikaelvesavuori/plain-browser/issues/new).
